...
| Gemma 4 | 🔵 | mlx_lm text backbone + mlx-vlm vision sidecar, paged generation | image input, no video/audio, causal attention over image tokens | `mlx-community/gemma-4-26B-A4B-it-OptiQ-4bit` |
